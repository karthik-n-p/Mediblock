...
const CreateDr = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const createUserResponse = await axios.post(`https://mediblock-ala2.onrender.com/create-user/${uid}`, { email: institutionalEmail , name: name });
      ...
      if (createUserResponse.data.success) {
        ...
        const saveDoctorResponse = await axios.post(`https://mediblock-ala2.onrender.com/save-doctor/${uid}`, doctorData);
