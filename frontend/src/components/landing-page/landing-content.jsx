...
export default function LandingContent() {
  ...
  const Feature = (props) => {
    ...
    return (
      <Box bg="#F9F9F9">
    <VStack pos={'relative'} pl={{md:"40px" ,base:"10px"}} bg={'#ECECEC'}  h="75vh"  gap={'50px'} >
    
      <VStack pt={'50px'} w={'100%'}  display={'flex'} alignItems={'flex-start'}  >
          <Flex flexDirection={{md:"row",base:"column"}}  gap={{base:'0px',md:"100px"}}>
          <Text color="#252525"  lineHeight={{md:"160px", base:"36px"}}  alignSelf={'flex-start'}    fontSize={{md:"156px", base:"56px"}} fontWeight={'600'} >Personalized</Text>
          <Button display={{ base:"none", md:"block"}}  alignSelf={'center'} mb={'-20px'} fontSize={'32px'} h="60px" w={'250px'}  borderRadius={'50px'} colorScheme="blue" bg="#0067FF" variant="solid" >Get Started</Button>
          </Flex>
        <Text fontWeight={'600'} lineHeight={{md:"100px", base:"56px"}} color="#252525" alignSelf={'start'}  fontSize={{md:"156px", base:"56px"}}  >Healthcare System</Text>
      </VStack>
      ...
      <HStack  h={'100%'}  w="90vw" display={'flex'} pl={{md:'70px', base:'10px'}} gap={{md:'300px', base:'5px'}}   >
        ...
        <Image zIndex={'100'}   position={'absolute'} right={{md:'10%',base:'0%'}}  bottom={{md:'-250px',base:'0%'}}    src={LandingPic} alt="LandingPic" w={{md:'500px',base:"260px"}} h={{md:'500px',base:"280px"}} />
...
<Box
  ...
  />
    ...
    <HStack  zIndex={'1'} pos={'relative'} my="10px"   w="100%" height={'120px'} bg="#0067FF" color="white" overflow="hidden"  >
  <HStack animation="marquee 10s linear infinite" gap={'50px'} >
  <Text fontSize="64px" fontWeight="bold" > Ai  </Text>
  <Text fontSize="64px" color={'black'} fontWeight="100" >&nbsp;+&nbsp;</Text>
  ...
  <HStack animation="marquee 10s linear infinite" gap={'50px'} >
    ...
    <Text fontSize="64px" color={'black'} fontWeight="thin" >+</Text>
    <Text fontSize="64px" fontWeight="bold" >BlockChain</Text>
    <Text fontSize="64px" color={'black'} fontWeight="thin" >+</Text>
    <Text fontSize="64px" fontWeight="bold" >Telemedicine</Text>
    <Text fontSize="64px" color={'black'} fontWeight="thin" >+</Text>
